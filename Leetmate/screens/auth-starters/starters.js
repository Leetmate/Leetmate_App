...
(function () {
    ...
    const PETS = [
        {
            ...
            spriteAsset: '../../assets/spritesheets/CubicBat.png',
        ...
        },
        {
            ...
            spriteAsset: '../../assets/spritesheets/CubicCat.png',
        ...
        },
        {
            ...
            spriteAsset: '../../assets/spritesheets/CubicFox.png',
    ...
    let currentIndex = 1; // Default to Lobo Guara
    let auth = null;
    let db = null;
